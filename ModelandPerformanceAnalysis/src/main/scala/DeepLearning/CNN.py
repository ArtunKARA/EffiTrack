...
# Verileri CNN için yeniden şekillendirme
...
cnn = Sequential([
    Conv1D(16, kernel_size=3, activation="relu", input_shape=train_features.shape[1:]),
    MaxPooling1D(pool_size=2),
    Flatten(),
    Dense(32, activation="relu"),
    Dropout(0.2),  # Hafif dropout ekledik
