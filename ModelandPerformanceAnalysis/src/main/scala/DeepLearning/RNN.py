...
# Verileri RNN için yeniden şekillendirme
train_features = train_features.reshape(train_features.shape[0], train_features.shape[1], 1)
val_features = val_features.reshape(val_features.shape[0], val_features.shape[1], 1)

# Basitleştirilmiş RNN Modeli
rnn = Sequential([
    SimpleRNN(16, activation="relu", input_shape=train_features.shape[1:]),
...
val_predictions = rnn.predict(val_features).flatten()
